<?php get_header('sapporo'); ?>

<?php //otokukon.site 札幌婚 ?>
...
<main>
    ...
    <section class="p-wedding l-wedding sapporo-hall">
        <div class="p-wedding__inner l-inner">
            ...
            <p class="p-wedding__copy">会場はこちら</p>
    ...
    <section class="p-contact l-contact" id="contact">
        <div class="p-contact__inner l-inner">
            ...
            <div class="p-contact__block">
                <?php echo do_shortcode('[mwform_formkey key="87"]'); ?>
            </div>
        </div>
    </section>
</main>
