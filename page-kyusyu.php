<?php get_header(); ?>
<?php //otokukon.site 九州婚
?>
<?php get_template_part( 'template/target' ); ?>
<main>
    <div class="p-mainview l-mainview">
        <picture class="p-mainview__img">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/mainview-pc_v2.jpg" media="(min-width: 768px)" />
            ...
            <div class="p-wedding__items">
                <div class="p-wedding__item p-wedding-card">
                    <div class="js_modalBtnCont" data-modal-btn="modal01">
                        <a class="p-wedding-card__ribon">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kokura01.jpg" alt="ベルクラシック小倉">
                        </a>
                        <div class="p-wedding-card__body">
                            <h3 class="p-wedding-card__title">ベルクラシック小倉</h3>
                            ...
                            <div class="p-wedding-card__content">
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kokura02.jpg" alt="ベルクラシック小倉">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/kokura03.jpg" alt="ベルクラシック小倉">
                                        </div>
                                    </div>
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        <h3 class="p-wedding-card__modaltitle">ベルクラシック小倉</h3>
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～100名)<br>
                                            北九州最大級のステンドグラス輝く独立型チャペル。自然光が差し込む貸切邸宅や、モダンなフロア貸切バンケット、家族との食事会、どの会場も記憶に残るひと時が生まれる。

                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare01" class="p-wedding-card__modalForm js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-wedding__item p-wedding-card">
                    <div class="js_modalBtnCont" data-modal-btn="modal02">
                        <a class="p-wedding-card__ribon">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shimonoseki01.jpg" alt="マリアージュ下関">
                        </a>
                        <div class="p-wedding-card__body">
                            <h3 class="p-wedding-card__title">マリアージュ下関</h3>
                            <div class="p-wedding-card__btn">詳しくはこちら</div>
                        </div>
                    </div>
                    <!-- モーダル（ポップアップ）の内容 -->
                            ...
                            <div class="p-wedding-card__content">
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shimonoseki02.jpg" alt="マリアージュ下関">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shimonoseki03.jpg" alt="マリアージュ下関">
                                        </div>
                                    </div>
                                    <div class="swiper-pagination"></div>
                                </div>
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        <h3 class="p-wedding-card__modaltitle">マリアージュ下関</h3>
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：15～200名)<br>
                                            光・水・緑をテーマとしたナチュラルで且つアットホームな挙式会場が登場♪
                                            優しく温かい陽の光と、ゲストの皆様からの祝福より、一生に一度の結婚式を！
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare02" class="p-wedding-card__modalForm js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    ...
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare03" class="p-wedding-card__modalForm js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-wedding__item p-wedding-card">
                    <div class="js_modalBtnCont" data-modal-btn="modal04">
                        <a class="p-wedding-card__ribon">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hofu01.jpg" alt="ベルクラシック防府">
                        </a>
                        <div class="p-wedding-card__body">
                            <h3 class="p-wedding-card__title">ベルクラシック防府</h3>
                            <div class="p-wedding-card__btn">詳しくはこちら</div>
                        </div>
                    </div>
                    <!-- モーダル（ポップアップ）の内容 -->
                            ...
                            <div class="p-wedding-card__content">
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hofu02.jpg" alt="ベルクラシック防府">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hofu03.jpg" alt="ベルクラシック防府">
                                        </div>
                                    </div>
                                    <div class="swiper-pagination"></div>
                                </div>
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        <h3 class="p-wedding-card__modaltitle">ベルクラシック防府</h3>
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～120名)<br>
                                            JR防府駅より徒歩5分、1日2組限定ゲストハウス型結婚式場。最新の映像演出を取り入れたチャペル、披露宴会場横には緑豊かなガーデン、おふたりとゲストとのひとときをプロデュースいたします。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare04" class="p-wedding-card__modalForm js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
