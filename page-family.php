<?php get_header(); ?>
<?php //otokukon.net otokukon.siteパパママ婚用
?>
<?php get_template_part('template/target'); ?>
<main>
    <div class="p-mainview l-mainview">
        <picture class="p-mainview__img">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/mainview-family.jpg" media="(min-width: 768px)" />
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mainview-sp-family.jpg" alt="抽選で20名様に！お得に叶えよう！結婚式プレゼント">
        </picture>
    ...
    <section class="p-special l-special p-special--family">
            ...
            <div class="p-special__items">
                <div class="p-special__item p-special-card">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img01-family.jpg" alt="<?php bloginfo('title'); ?>">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <h3 class="p-special-card__title">2.新郎新婦衣装</h3>
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img02-family.jpg" alt="2.新郎新婦衣装">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img03-family.jpg" alt="3.お写真">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img04-family.jpg" alt="4.婚礼料理フルコース">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img05-family.jpg" alt="５.フリードリンク">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img06-family.jpg" alt="6.ブーケ">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img07-family.jpg" alt="7.会場装花">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img08-family.jpg" alt="8.芳名帳">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img09-family.jpg" alt="9.テーブルセット">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img10-family.jpg" alt="10.着付料">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img11-family.jpg" alt="11.音響照明">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img12-family.jpg" alt="12.司会者">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img13-family.jpg" alt="13.会場料">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img14-family.jpg" alt="14.介添え料">
                    </div>
                </div>
                <div class="p-special__item p-special-card">
                    <div class="p-special-card__ribon">
                    ...
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img15-family.jpg" alt="15.引き出物・引き菓子">
                    </div>
                </div>
                <div class="p-special__item p-special-card u-mobile">
                    <div class="p-special-card__img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img16-family.png" alt="<?php bloginfo('title'); ?>">
                    </div>
                </div>
            </div>
            <div class="p-special__itemFamily u-desktop">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/special-img01-familiy.png" alt="<?php bloginfo('title'); ?>">
            </div>
    ...
    <section class="p-wedding l-wedding">
        <div class="p-wedding__inner l-inner">
            ...
            <p class="p-wedding__copy">ご希望の会場をお選びいただけます。</p>
                ...
                <div class="p-wedding__item p-wedding-card">
                    <div class=" js_modalBtnCont" data-modal-btn="modal01">
                        ...
                        <div class="p-wedding-card__body">
                            ...
                            <div class="p-wedding-card__btn p-wedding-card__btn--family">詳しくはこちら</div>
                        </div>
                    </div>
                    <!-- モーダル（ポップアップ）の内容 -->
                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                <div class="swiper">
                                    ...
                                    <div class="swiper-pagination swiper-pagination--family"></div>
                                </div>
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～100名)<br>
                                            緑を見渡しながらの挙式を執り行うことができる真っ白なチャペル。披露宴会場では、壁三面を使用したプロジェクションマッピングなど多彩な演出も可能です。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare01" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～120名)<br>
                                            2020年3月1日、グランドリニューアルオープンオープン。自然光が降り注ぐ独立型大聖堂と、25mのバージンロードが魅力の会場。プライベートガーデンもフォトジェニックと大人気。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare02" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～150名)<br>
                                            クリスタルと光のチャペル。絵本から飛び出たかのようなナチュラルな三角屋根の教会。自然の偉大さを感じずにはいられない空間をご用意しております。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare03" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～180名)<br>
                                            白いバラが敷き詰められたガラスのバージンロードを幻想的な光が彩り、純白のドレスも輝きを増します。プライベートな邸宅で叶えるオリジナルウェディング。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare04" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    ...
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare05" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：6～120名)<br>
                                            最新演出「プロジェクションマッピング」を取り入れたゲストハウス！水と緑が溢れる広大な敷地には、開放感たっぷり独立型のガラス張りチャペルが。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare06" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：2～50名)<br>
                                            観光名所としても有名な嵯峨嵐山に佇むチャペル。 京都の田園風景の中にの可愛い一軒家がWEDDINGの舞台。優しい木漏れ日に満ちたガーデンにほっこり。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare07" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    ...
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare08" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～100名)<br>
                                            一歩足を踏み入れるとそこはもうドラマの１シーンのような別世界。扉が開かれた瞬間、天窓から優しい光が降り注ぐバージンロード。真っ白なキャンバスに描くウェディング。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare09" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    <div class="p-wedding-card__modalbody">
                                        ...
                                        <p class="p-wedding-card__modaltext">
                                            (収容人数：10～200名)<br>
                                            広大な敷地内に、ステンドグラスが煌めく大聖堂やガーデン、 大階段など、おふたりの憧れを叶える空間が揃う。神聖な雰囲気の中に流れるかけがえのない時間。
                                        </p>
                                    </div>
                                    <div class="p-wedding-card__other">
                                        <a id="js-pare10" class="p-wedding-card__modalForm p-wedding-card__modalForm--family js-pagelink" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="p-case l-case p-case--family">
    ...
    <section class="p-qa l-qa p-qa--family">
                        ...
                        <div class="p-qa-media__foot js-tab-target" id="tab01">
                            <div class="p-qa-media__block">
                                <div class="p-qa-media__a">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/q-media-a-family.jpg" alt="A">
                                </div>
                                <div class="p-qa-media__content">
                                    <div class="p-qa-media__answer p-qa-media__answer--family">費用がかかる場合もございます。</div>
                                </div>
                            </div>
                    ...
                    <div class="p-qa-media__inner  js-tab-trigger" data-id="tab02">
                        ...
                        <div class="p-qa-media__foot js-tab-target" id="tab02">
                            <div class="p-qa-media__block">
                                ...
                                <div class="p-qa-media__answer p-qa-media__answer--family">辞退は可能です。</div>
                            </div>
                            <p class="p-qa-media__dtail">
                    ...
                    <div class="p-qa-media__inner js-tab-trigger" data-id="tab03">
                        ...
                        <div class="p-qa-media__foot js-tab-target" id="tab03">
                            <div class="p-qa-media__block">
                                ...
                                <div class="p-qa-media__answer p-qa-media__answer--family">はい、可能です。</div>
                            </div>
                            <p class="p-qa-media__dtail">
                    ...
                    <div class="p-qa-media__inner js-tab-trigger" data-id="tab04">
                        ...
                        <div class="p-qa-media__foot js-tab-target" id="tab04">
                            <div class="p-qa-media__block">
                                ...
                                <div class="p-qa-media__answer p-qa-media__answer--family">3～5回程度となります。</div>
                            </div>
                            <p class="p-qa-media__dtail">
    ...
    <section class="p-contents l-contents">
        <div class="p-contents__inner">
            <div class="p-contents__items">
                <div class="p-contents__item p-contents-cardFamily">
                    <picture class="p-contents-card__img">
                        <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/contents-family-img01.png" media="(min-width: 768px)" />
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/contents-family-img01-sp.jpg" alt="SERVICE">
                    </picture>
                    <div class="p-contents-card__body p-contents-family">
                        <div class="p-contents-family__items">
                            <div class="p-contents-family__item">
                                <div class="p-contents-family__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/service-img01-family.png" alt="Case01"></div>
                                <p class="p-contents-family__text">
                                    <span>お子様が飽きずに</span>家族で楽しめる演出
                                </p>
                            </div>
                            <div class="p-contents-family__item">
                                <div class="p-contents-family__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/service-img02-family.png" alt="Case02"></div>
                                <p class="p-contents-family__text">
                                    打ち合わせから式当日までスタッフが<br class="u-desktop"><span>完全サポート</span>させていただきます
                                </p>
                            </div>
                            <div class="p-contents-family__item">
                                <div class="p-contents-family__img"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/service-img03-family.png" alt="Case03"></div>
                                <p class="p-contents-family__text">
                                    式場内は小さなお子様も安心の<span>バリアフリー</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="p-contents__item p-contents-card">
                        <picture class="p-contents-card__img">
                            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/contents-family-img02.png" media="(min-width: 768px)" />
                        ...
                        <div class="p-contents-card__body p-contents-card__body--reverse">
                            <h2 class="p-contents-card__title p-contents-card__title--second"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/contents-title02-family.png" alt="Benguet Corde"></h2>
                            <p class="p-contents-card__text">
                                多彩な会場演出で、<br class="u-mobile">
                                おふたりだけの<br class="u-desktop">世界を再現する<br class="u-mobile">
                                空間づくり。<br>
    ...
    <section class="p-family-voice l-family-voice">
        <div class="p-family-voice__inner l-inner p-family-voiceFamily">
            <h2 class="p-family-voice__title">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-title.png" alt="Voice">
            </h2>
            <div class="p-family-voice__copy">挙式されたお客様からの喜びの声</div>
            <div class="p-family-voice__familyVoice p-voiceFamily">
                <div class="p-voiceFamily__items">
                    <div class="p-voiceFamily__item">
                        <h3 class="p-voiceFamily__title u-mobile">
                            子どもを連れての打ち合わせも安心！<span>新婦H様</span>
                        </h3>
                        <div class="p-voiceFamily__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-img01-family.jpg" alt="子どもを連れての打ち合わせも安心！">
                        </div>
                        <div class="p-voiceFamily__body">
                            <h3 class="p-voiceFamily__title u-desktop">
                                子どもを連れての打ち合わせも安心！<span>新婦H様</span>
                            </h3>
                            <div class="p-voiceFamily__text">
                    ...
                    <div class="p-voiceFamily__item">
                        <h3 class="p-voiceFamily__title u-mobile">
                            子供から大人まで楽しめる結婚式！<span>新婦M様</span>
                        </h3>
                        <div class="p-voiceFamily__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-img02-family.jpg" alt="子供から大人まで楽しめる結婚式！">
                        </div>
                        <div class="p-voiceFamily__body">
                            <h3 class="p-voiceFamily__title u-desktop">
                                子供から大人まで楽しめる結婚式！<span>新婦M様</span>
                            ...
                            <div class="p-voiceFamily__text">
                                両親、兄の挙げた式場で私も挙式することが夢でした。
                                子どもが多かったのでベールを持ってくれるトレーンガール、リングガール、 フラワーキッズなど<span>子ども達の出番もたくさん作り、 主役になれる挙式</span>にこだわりました。<br>
                                妊娠入院・出産とバタバタの中での計画でしたが、私たちの予定に合わせてくれて本当に助かりました。<br class="u-mobile"><span>沢山の笑顔が溢れ、子どもから大人まで楽しむ事の出来る結婚式</span>になりました。
                            </div>
                        </div>
                    </div>
                    <div class="p-voiceFamily__item">
                        <h3 class="p-voiceFamily__title u-mobile">
                            妊娠しても結婚式を挙げられた！<span>新婦O様</span>
                        </h3>
                        <div class="p-voiceFamily__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-img03-family.jpg" alt="妊娠しても結婚式を挙げられた！">
                        </div>
                        <div class="p-voiceFamily__body">
                            <h3 class="p-voiceFamily__title u-desktop">
                                妊娠しても結婚式を挙げられた！<span>新婦O様</span>
                            ...
                            <div class="p-voiceFamily__text">
                                ...
                                式当日までの間、<span>担当プランナーさんに体調をいつも気遣っていただいた</span>ので、安心して準備をすすめることが出来ました。<br class="u-mobile">本当に感謝しています。
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="p-contact l-contact p-contact--family" id="contact">
